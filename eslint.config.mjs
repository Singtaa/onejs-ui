...
export default tseslint.config(
    ...
    },
    {
        rules: {
            ...
            // The CS-destructure restriction is this package's addition: its
            // source goes through the esbuild import transform, so ES6
            ...
            "no-restricted-syntax": ["error", {
                ...
                message: "Prefer the ES6 import style: import { X } from \"UnityEngine\" (the esbuild plugin transforms it at build time).",
            }, {
                selector: "VariableDeclarator[id.type='ObjectPattern'][init.object.object.name='CS']",
                message: "Prefer the ES6 import style: import { X } from \"UnityEngine/UIElements\" (the esbuild plugin transforms it at build time).",
            }],
        },
    },
)
